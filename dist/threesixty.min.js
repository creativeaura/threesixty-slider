(function(d){d.ThreeSixty=function(e,h){var b=this,a,g=[];b.$el=d(e);b.el=e;b.$el.data("ThreeSixty",b);b.init=function(){a=d.extend({},d.ThreeSixty.defaultOptions,h);a.parallel||b.loadImages();a.disableSpin&&(a.currentFrame=1,a.endFrame=2);b.initProgress()};b.initProgress=function(){b.$el.css({width:a.width+"px",height:a.height+"px"}).css(a.styles);b.$el.find(a.progress).css({marginTop:a.height/2-15+"px"});b.$el.find(a.progress).fadeIn("slow");b.$el.find(a.imgList).hide()};b.loadImages=function(){var c,
f;c=document.createElement("li");f=a.domain+a.imagePath+a.filePrefix+(a.loadedImages+1)+a.ext+(d.browser.msie?"?"+(new Date).getTime():"");f=d("<img>").attr("src",f).addClass("previous-image").appendTo(c);g.push(f);b.$el.find(a.imgList).append(c);d(f).load(function(){b.imageLoaded()})};b.imageLoaded=function(){a.loadedImages+=1;d(a.progress+" span").text(Math.floor(100*(a.loadedImages/a.totalFrames))+"%");a.loadedImages>=a.totalFrames?(g[0].removeClass("previous-image").addClass("current-image"),
d(a.progress).fadeOut("slow",function(){d(this).hide();b.showImages();b.showNavigation()})):b.loadImages()};b.showImages=function(){b.$el.css("background-image","none");b.$el.find(".txtC").fadeIn();b.$el.find(a.imgList).fadeIn();a.ready=!0;b.initEvents();b.refresh()};b.showNavigation=function(){if(a.navigation&&!a.navigation_init){var c,f,e,g;c=d("<div/>").attr("class","nav_bar");f=d("<a/>").attr({href:"#","class":"nav_bar_next"}).html("next");e=d("<a/>").attr({href:"#","class":"nav_bar_previous"}).html("previous");
g=d("<a/>").attr({href:"#","class":"nav_bar_play"}).html("play");c.append(e);c.append(g);c.append(f);b.$el.prepend(c);f.bind("mousedown touchstart",b.next);e.bind("mousedown touchstart",b.previous);g.bind("mousedown touchstart",b.play_stop);a.navigation_init=!0}};b.play_stop=function(c){c.preventDefault();a.autoplay?(a.autoplay=!1,d(c.currentTarget).removeClass("nav_bar_stop").addClass("nav_bar_play"),clearInterval(a.play),a.play=null):(a.autoplay=!0,a.play=setInterval(b.moveToNextFrame,40),d(c.currentTarget).removeClass("nav_bar_play").addClass("nav_bar_stop"))};
...
monitorInt:10,ticker:0,speedMultiplier:7,totalFrames:180,currentFrame:0,endFrame:0,loadedImages:0,framerate:60,domains:null,domain:"",parallel:!1,queueAmount:8,idle:0,filePrefix:"",ext:"png",height:300,width:300,styles:{},navigation:!1,autoplay:!1,autoplayDirection:1,disableSpin:!1};d.fn.ThreeSixty=function(e){return Object.create(new d.ThreeSixty(this,e))}})(jQuery);"function"!==typeof Object.create&&(Object.create=function(d){function e(){}e.prototype=d;return new e});
