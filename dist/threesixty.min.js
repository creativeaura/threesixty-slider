...
b.next=function(c){c&&c.preventDefault();a.endFrame-=5;b.refresh()};b.previous=function(c){c&&c.preventDefault();a.endFrame+=1;b.refresh()};b.play=function(){a.autoplay||(a.autoplay=!0,a.play=setInterval(b.moveToNextFrame,40))};b.stop=function(){a.autoplay&&(a.autoplay=!1,clearInterval(a.play),a.play=null)};b.moveToNextFrame=function(){a.endFrame-=1;b.refresh()};b.initEvents=function(){b.$el.bind("mousedown touchstart touchmove touchend mousemove click",function(c){c.preventDefault();"mousedown"===
c.type&&1===c.which||"touchstart"===c.type?(a.pointerStartPosX=b.getPointerEvent(c).pageX,a.dragging=!0):"touchmove"===c.type?b.trackPointer(c):"touchend"===c.type&&(a.dragging=!1);"click"===c.type&&!d.browser.msie&&b.$el.css("cursor","url(assets/images/hand_closed.png), auto")});d(document).bind("mouseup",function(){a.dragging=!1;d(this).css("cursor","none")});d(document).bind("mousemove",function(c){a.dragging?(c.preventDefault(),d.browser.msie||b.$el.css("cursor","url(assets/images/hand_closed.png), auto")):
d.browser.msie||b.$el.css("cursor","url(assets/images/hand_open.png), auto");b.trackPointer(c)})};b.getPointerEvent=function(a){return a.originalEvent.targetTouches?a.originalEvent.targetTouches[0]:a};b.trackPointer=function(c){a.ready&&a.dragging&&(a.pointerEndPosX=b.getPointerEvent(c).pageX,a.monitorStartTime<(new Date).getTime()-a.monitorInt&&(a.pointerDistance=a.pointerEndPosX-a.pointerStartPosX,a.endFrame=a.currentFrame+Math.ceil((a.totalFrames-1)*a.speedMultiplier*(a.pointerDistance/b.$el.width())),
b.refresh(),a.monitorStartTime=(new Date).getTime(),a.pointerStartPosX=b.getPointerEvent(c).pageX))};b.refresh=function(){0===a.ticker&&(a.ticker=setInterval(b.render,Math.round(1E3/a.framerate)))};b.render=function(){var c;a.currentFrame!==a.endFrame?(c=a.endFrame<a.currentFrame?Math.floor(0.1*(a.endFrame-a.currentFrame)):Math.ceil(0.1*(a.endFrame-a.currentFrame)),b.hidePreviousFrame(),a.currentFrame+=c,b.showCurrentFrame()):(window.clearInterval(a.ticker),a.ticker=0)};b.hidePreviousFrame=function(){g[b.getNormalizedCurrentFrame()].removeClass("current-image").addClass("previous-image")};
b.showCurrentFrame=function(){g[b.getNormalizedCurrentFrame()].removeClass("previous-image").addClass("current-image")};b.getNormalizedCurrentFrame=function(){var b=Math.ceil(a.currentFrame%a.totalFrames);0>b&&(b+=a.totalFrames-1);return b};b.init()};d.ThreeSixty.defaultOptions={dragging:!1,ready:!1,pointerStartPosX:0,pointerEndPosX:0,pointerDistance:0,monitorStartTime:0,monitorInt:10,ticker:0,speedMultiplier:7,totalFrames:180,currentFrame:0,endFrame:0,loadedImages:0,framerate:60,domains:null,domain:"",
parallel:!1,queueAmount:8,idle:0,filePrefix:"",ext:"png",height:300,width:300,styles:{},navigation:!1,autoplay:!1};d.fn.ThreeSixty=function(e){return Object.create(new d.ThreeSixty(this,e))}})(jQuery);"function"!==typeof Object.create&&(Object.create=function(d){function e(){}e.prototype=d;return new e});
