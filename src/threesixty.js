...
(function ($) {
  ...
  $.ThreeSixty = function (el, options) {
    ...
    var base = this, AppCongif, frames = [], cl;
    ...
    base.showImages = function () {
      ...
      if (typeof(AppCongif.loaded) === 'function') {
        AppCongif.loaded();
      }
    };
    ...
    base.initEvents = function () {
      base.$el.bind('mousedown touchstart touchmove touchend mousemove click', function (event) {
        ...
        if (event.type === 'click' && !$.browser.msie) {
          //base.$el.css("cursor", "url(assets/hand_closed.png), auto");
        }
      });
    ...
    base.showCurrentFrame = function () {
      var theFrame = base.getNormalizedCurrentFrame();
      frames[theFrame].removeClass("previous-image").addClass("current-image");
      AppCongif.change.call(base, theFrame);
    };
  ...
  $.ThreeSixty.defaultOptions = {
    ...
    /**
     * @cfg {Function} loaded
     * Callback function triggers once when the slider is loaded and ready.
     */
    loaded: function() {},
    /**
     * @cfg {Function} change
     * Callback function broadcast the current frame change
     */
    change: function() {},
    /**
     * @cfg {Boolean} drag
